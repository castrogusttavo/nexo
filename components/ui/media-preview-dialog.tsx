...
const DEFAULT_DOWNLOAD_FILENAME = 'imagem'
        ...
        <div className='relative flex max-h-screen w-full items-center'>
          ...
          >
            <div className='flex gap-1'>
              <button {...prevProps} className={cn(buttonVariants({ variant: prevDisabled ? 'disabled' : 'default' }))} type='button'>
                <ArrowLeft />
              </button>
              {(currentUrlIndex ?? 0) + 1}
              <button {...nextProps} className={cn(buttonVariants({ variant: nextDisabled ? 'disabled' : 'default' }))} type='button'>
                <ArrowRight />
              </button>
            </div>
            <div className='flex'>
              <button className={cn(buttonVariants({ variant: zoomOutDisabled ? 'disabled' : 'default' }))} {...zommOutProps} type='button'>
              ...
              <button className={cn(buttonVariants({ variant: zoomInDisabled ? 'disabled' : 'default' }))} {...zoomInProps} type='button'>
                <Plus className='size-4' />
              </button>
            </div>
            <button
              className={cn(buttonVariants({ variant: downloadDisabled ? 'disabled' : 'default' }))}
