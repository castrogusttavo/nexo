...
export function WebHeader() {
  ...
  return (
    <header
      className={cn(
        'hidden mx-auto md:grid h-[72px] w-full grid-cols-[1fr_auto_1fr] items-center px-4 sm:px-8 xl:px-11 sticky top-0 bg-background z-50 border-2 border-t-0 border-border transition-[max-width,border-radius,border-color] duration-300 ease-out',
        scrolled
