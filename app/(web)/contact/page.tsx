import { Call02Icon } from '@hugeicons-pro/core-solid-rounded'
...
const CONTACT_CARDS: ContactCard[] = [
  ...
  },
  {
    ...
    cta: 'contato@nexo.coodee.dev',
    href: 'mailto:contato@nexo.coodee.dev',
  },
]
            ...
            {CONTACT_CARDS.map((card) => (
              ...
              >
                <div className='flex size-10 items-center justify-center rounded-md border border-border'>
                  <NexoIcon icon={Call02Icon} strokeWidth={2} size={24} />
                </div>
